...
def calcular_custo_fichas(numeros_previstos, valor_ficha=1):
    ...
    quantidade_vizinhos = quantidade_numeros_previstos * 4  # Cada número previsto tem 6 vizinhos
    ...
    if numeros_previstos:
        ...
        if numero_atual in numeros_previstos:
            ...
            for num_previsto in numeros_previstos:
                ...
                vizinhos_indices = [(indice_num_previsto + i) % len(numeros_ordenados) for i in range(-2, 3)]
